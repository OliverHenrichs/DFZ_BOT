// role management
module.exports = {
	// classes of rolesTIER_1=714060877237714964

	beginnerRoles: [process.env.TIER_1, process.env.TIER_2, process.env.TIER_3, process.env.TIER_4],
	...
	*/
	findRole: function (message, rolesToCheck) {
		...
		//console.log("In findRole, rolesToCheck = " + rolesToCheck.join(", ") + ", message = " + message);
		if (rolesToCheck.length === 0) {
			//console.log("rolesToCheck.length === 0");
			return undefined;
		}
		...
		//console.log("Found = " + message.member.roles.find(role => rolesToCheck.includes(role.name)));
