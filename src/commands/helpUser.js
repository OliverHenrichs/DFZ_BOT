...
module.exports = async (message) => {
    ...
    addHelpToTable(_embed, "help", "!help / !helpme", "Shows you the info you are looking at right now 😉\n Use !helpme to avoid also getting a message from MEE6-bot.", "!help");
    // help admin commands
    if (rM.findRole(message.member, rM.adminRoles) != undefined) {
        addHelpToTable(_embed, "post", "!post <lobbytype> <region> <tiers> <time> <timezone>", "Creates a lobby in the channel in which you write the command.\nLobby types: " +
            ...
            "\n timezone: CET, ... check https://kevinnovak.github.io/Time-Zone-Picker/ to find your timezone name.", "!post " +
            ...
            " 10:00am CET");
        addHelpToTable(_embed, "update", "!update <msgId> -tiers <tiers>", "Updates the lobby that is associated with the given message-ID " +
            "(get lobby's message-ID: activate developer mode in Discord options, " +
            "then rightclick the lobby post and click 'copy ID')\n" +
            "Available options: -tiers <tiers> Give tiers you want to allow in this lobby (e.g. '1,2')", "!update 791413627105312769 -tiers 1,2,3");
        addHelpToTable(_embed, "highscore", "!highscore -type <type>", "Shows you an all-time coach ranking displaying who coached how much", "!highscore\n!highscore -type normal\n!highscore -type tryout");
