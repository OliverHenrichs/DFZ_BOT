...
class Player {
     ...
     */
    constructor(userId: string = "", tag: string = "", referredBy: string = "", referralLock: number = 0, lobbyCount: number = 0, lobbyCountUnranked: number = 0, lobbyCountBotBash: number = 0, lobbyCount5v5: number = 0, lobbyCountReplayAnalysis: number = 0, offenses: number = 0) {
        this.userId = userId;
        this.tag = tag;
