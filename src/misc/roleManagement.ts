...
module.exports = {
  ...
  isAdminRole: function (role: string) {
    return this.adminRoles.find((r: string) => r === role);
  },
  ...
  /**
	...
	*/
  findRole: function (member: GuildMember, rolesToCheck: Array<string>) {
  ...
  /**
	...
	*/
  getNumberFromBeginnerRole: function (roleId: string) {
    switch (roleId) {
   ...
   */
  getRegionalRolePrefix: function (roleId: string) {
    switch (roleId) {
   ...
   */
  getRegionalRoleTimeZoneString: function (roleId: string) {
    switch (roleId) {
      case regionRoleIDs[0]:
   ...
   * @return corresponding regional prefix
   */
  getRegionalRoleString: function (roleId: string) {
    switch (roleId) {
      case regionRoleIDs[0]:
        return "EU";
      case regionRoleIDs[1]:
   ...
   * @return corresponding regional prefix
   */
  getRegionalRoleLobbyChannel: function (roleId: string) {
    switch (roleId) {
      case regionRoleIDs[0]:
   ...
   */
  getRegionalRoleFromString: function (roleString: string) {
    switch (roleString) {
      case "EU":
  ...
  /**
	...
	*/
  getRoleMentions: function (roles: Array<string>) {
    return roles
      .map((tier) => {
        return `<@&${tier}>`;
      })
  ...
  /**
	...
	*/
  getRoleMention: function (role: string) {
    return `<@&${role}>`;
  },
};
